export const zhCNLaunch: Record<string, string> = {
  ...
  "Agent model id": "Agent 侧模型 ID",
  "Model list": "模型列表",
  "{{agent}} model list": "{{agent}} 模型列表",
  "Configure the model names exposed to the agent and the upstream model each name routes to.":
    "配置暴露给 Agent 的模型名，以及每个名称对应转发到的上游模型。",
  "Upstream model": "上游模型",
  "Remove model": "移除模型",
  "Add model": "添加模型",
  "No models": "没有模型",
  ...
  "Add header": "添加请求头",
  "Remove header": "移除请求头",
  "Configure API bridge headers.": "配置 API 转接请求头。",
  "Setup guide": "配置指南",
  "Manual setup": "手动配置",
  ...
  "Header {{name}} value cannot contain line breaks":
    "请求头 {{name}} 的值不能包含换行",
  "Header {{name}} is managed by the API bridge":
    "请求头 {{name}} 由 API 转接管理，不能自定义",
  ...
  "via API bridge": "通过 API 转接",
  unsupported: "不支持",
  "{{agent}} connects through the API bridge to {{provider}} {{apiType}}":
    "{{agent}} 通过 API 转接连接到 {{provider}} {{apiType}}",
